        ...
        <div class="modal-content bg-dark border-secondary">
            <form action="<?= base_url('pedidos/guardar_categoria') ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body p-4">
                    ...
                    <input type="text" name="nombre_categoria" class="form-control bg-dark text-white border-secondary mb-3" placeholder="Nombre (ej: Helados)" required>
                    <div class="mb-3">
                        <label class="small text-secondary">Foto de Marca</label>
                        <input type="file" name="foto_categoria" class="form-control bg-dark text-white border-secondary" accept="image/*">
                    </div>
                    <button type="submit" class="btn btn-accent w-100 py-2 fw-bold">GUARDAR</button>
                </div>
            </form>
        </div>
    </div>
